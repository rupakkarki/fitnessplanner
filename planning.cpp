...
std::map<std::string, std::string> work_desc = {
    {"Lat Pulldown", "To perform a lat pulldown, sit at the lat pulldown machine and grip the bar with your hands wider than shoulder-width apart. Pull the bar down towards your chest while keeping your back straight and elbows pointed down. Slowly return the bar to the starting position with controlled movement."},
    {"Rowing", "Keep your knees slightly bent, core tight with a slight lean back in your upper body. Now do that in reverse: extend your arms, lean forward from your hips, and bend your knees to return to your start."},
    {"Barbell Curl", "To perform a barbell curl, stand with your feet shoulder-width apart and hold a barbell with an underhand grip (palms facing up), hands shoulder-width apart. Keep your elbows close to your torso, and curl the barbell up towards your shoulders by bending your elbows. Lower the barbell back to the starting position in a controlled manner."},
    {"Dumbbell Curl", "To perform a dumbbell curl, stand with your feet shoulder-width apart and hold a dumbbell in each hand with an underhand grip (palms facing up). Keep your elbows close to your torso and curl the dumbbells up towards your shoulders by bending your elbows. Lower the dumbbells back to the starting position in a controlled manner."},
    {"Pulley Pushdown", "To perform a pulley pushdown, stand facing the pulley machine with a high pulley attachment. Grip the bar with an overhand grip (palms facing down), hands shoulder-width apart. Keeping your elbows close to your body, push the bar down until your arms are fully extended. Slowly return the bar to the starting position with controlled movement."},
    {"Skull Crusher", "To perform a skull crusher, lie on a flat bench with a barbell or EZ curl bar. Hold the bar with an overhand grip, hands shoulder-width apart. Extend your arms straight up, then slowly lower the bar towards your forehead by bending your elbows. Push the bar back to the starting position in a controlled manner."},
    {"Military Press", "To perform a military press, stand with your feet shoulder-width apart and hold a barbell at shoulder level with an overhand grip (palms facing forward). Press the barbell overhead by extending your arms, then lower it back to shoulder level with controlled movement."},
    {"Shrugs", "To perform shrugs, stand with your feet shoulder-width apart and hold a dumbbell in each hand at your sides. Shrug your shoulders up towards your ears, then slowly lower them back to the starting position."},
    {"Squat", "To perform a squat, stand with your feet shoulder-width apart and hold a barbell across your upper back. Bend your knees and hips to lower your body into a squat position, keeping your back straight and chest up. Push through your heels to return to the starting position."},
    {"Leg Press", "To perform a leg press, sit on the leg press machine with your feet shoulder-width apart on the platform. Push the platform away by extending your legs, then slowly return to the starting position by bending your knees."},
    {"Bench Press", "To perform a bench press, lie on a flat bench with your feet flat on the floor. Hold a barbell with an overhand grip (palms facing forward), hands slightly wider than shoulder-width apart. Lower the barbell to your chest, then push it back up to the starting position."}};
...
public:
    ...
    void recommendNutrition()
    {
        if (bodyType == "ectomorph")
        {
            ...
            std::cout << " - Eat frequently and incorporate snacks\n";
            std::cout << " - Emphasize starchy vegetables and whole grains\n";
        }
        else if (bodyType == "endomorph")
        {
            ...
            std::cout << " - Emphasize lean proteins, vegetables, and whole grains\n";
            std::cout << " - Avoid processed foods and sugary drinks\n";
        }
        else if (bodyType == "mesomorph")
        {
            ...
            std::cout << " - Include a variety of fruits and vegetables\n";
            std::cout << " - Maintain regular meal timing\n";
        }
        else
        {
            std::cout << "Unknown body type.\n";
    ...
    void recommendWorkout()
    {
        if (bodyType == "ectomorph")
        {
            ...
            for (const auto &pair : workouts)
            {
                std::cout << "\n"
                          << i << ") " << pair.first << "\n";
                std::cout << "- " << workoutDescription << "\n";
                for (const auto &exercise : pair.second)
                {
                    std::cout << "- " << exercise << ": " << work_desc[exercise] << "\n";
                }
                i++;
                std::cout << "\n";
            }
